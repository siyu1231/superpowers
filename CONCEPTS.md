...
## Regression Guard
The CLI-level verification engine that runs regression cases with environment-variable toggle comparison (ON/OFF), dispatches debug subagents on failure, and accumulates passing cases into the regression case library. Called by subagent-driven-development.
